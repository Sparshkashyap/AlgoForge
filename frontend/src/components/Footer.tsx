        ...
        <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="max-w-xl">
            ...
            <p className="mt-5 text-sm leading-8 text-muted-foreground md:text-base">
              ...
              Sharper prep workflows, cleaner practice surfaces, and stronger
              product direction.
            </p>
              ...
              <div className="mt-4 space-y-3">
                {productLinks.map((link) => (
                  <Link
                    key={link.to}
                    to={link.to}
                    className="group flex items-center justify-between rounded-xl px-3 py-2 text-sm text-muted-foreground transition hover:bg-background/50 hover:text-foreground"
                  >
